...
class QRScanner : CDVPlugin, AVCaptureMetadataOutputObjectsDelegate {
        ...
        do {
            if (captureSession?.isRunning != true){
                ...
                metaOutput!.metadataObjectTypes = [AVMetadataObject.ObjectType.qr, AVMetadataObject.ObjectType.code128,
                    ...
                    AVMetadataObject.ObjectType.upca, AVMetadataObject.ObjectType.upce]
    ...
    func metadataOutput(_ captureOutput: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if (found.type == AVMetadataObject.ObjectType.qr || found.type == AVMetadataObject.ObjectType.code128
                || found.type == AVMetadataObject.ObjectType.ean8 || found.type == AVMetadataObject.ObjectType.code13
                || found.type == AVMetadataObject.ObjectType.upca || found.type == AVMetadataObject.ObjectType.upce) && found.stringValue != nil {
            scanning = false
